...
const MENU = [
  ...
  { id: "smashveg", type: "smash", name: "Smash veg", desc: "Patty plant based, cipolla, veg cheddar, ketchup, senape", solo: 9.0, menu: 14.5, veg: true, allergens: [1,6,10], active: true, order: 4,
    ingredients: ["Veg cheddar", "Cipolla", "Ketchup", "Senape"],
    swaps: [{ id: "panevegano", name: "Pane vegano" }] },
  { id: "chicken",    type: "burger", name: "Chicken",     desc: "Pollo fritto, pickles, coleslaw, salsa bianca", solo: 9.0, menu: 14.5, veg: false, allergens: [1,3,7,8,10,12], active: true, order: 5,
    ingredients: ["Salsa bianca", "Pickles", "Coleslaw"],
    swaps: [{ id: "panevegano", name: "Pane vegano" }] },
  { id: "pulledpork", type: "burger", name: "Pulled Pork", desc: "Maiale sfilacciato, coleslaw, salsa BBQ", solo: 10.0, menu: 15.5, veg: false, allergens: [1,3,7,10], active: true, order: 6,
    ingredients: ["Coleslaw"],
    swaps: [{ id: "panevegano", name: "Pane vegano" }] },
  { id: "burgerveg",  type: "burger", name: "Burgerveg",   desc: "Tofu affumicato fritto, pickles, coleslaw veg, salsa", solo: 9.0, menu: 14.5, veg: true, allergens: [1,6,10,12], active: true, order: 7,
